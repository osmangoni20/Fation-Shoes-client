...
const SearchItem = () => {
  ...
  const [productsData, setProductData] = useState<TProductInfo[]>([]);
  const [itemsPerPage, setItemPerPage]=useState(5);
  const [currentPage, setCurrentPage]=useState(0)
  const paginationParamsData={dataSize:productsData.length, itemsPerPage, currentPage, setItemPerPage,  setCurrentPage}
