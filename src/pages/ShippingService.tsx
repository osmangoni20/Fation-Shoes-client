  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4 sm:p-6">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 sm:p-8 lg:p-12">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 text-center text-gray-800">
          Shipping Services
        </h1>

        <p className="mb-4 sm:mb-6 text-gray-700 text-sm sm:text-base lg:text-lg">
        ...
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold mt-6 sm:mt-8 mb-4 text-gray-800">
          1. Shipping Methods
        </h2>
