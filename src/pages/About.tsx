...
const About = () => {
    return (
      ...
      <figure>
              <img className='h-[300px] w-screen' src='https://img.freepik.com/premium-photo/photo-sport-shoe-mockup-icon-presentation-background-generative-ai_392592-3117.jpg?w=740'></img>
        </figure>
      <figure>
        <img
            src="https://plus.unsplash.com/premium_photo-1663100769321-9eb8fe5a8e6b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8c2hvZXN8ZW58MHx8MHx8fDA%3D"
        ...
        <figure>
              <img className='h-[300px] w-screen' src='https://img.freepik.com/premium-photo/pair-sport-shoes-surrounded-by-magical-smoke-that-shimmers-glows-light_124507-142120.jpg?w=740'></img>
        </figure>
      </div>
...
We trade on the NASDAQ Stock Market under the symbol SCVL. Investors and stakeholders can access our press releases, annual report, and other investor and stakeholder information, including our code of ethics, at our Investor Relations website.
            ...
            <button className="btn text-lg text-white font-semibold bg-primary hover:bg-secondary">Get Started</button>
