  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4 sm:p-6 md:p-8">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 sm:p-8 md:p-12">
        ...
        <p className="mb-4 text-gray-700 text-sm sm:text-base md:text-lg">We may collect the following types of information:</p>
        ...
        <p className="mb-4 text-gray-700 text-sm sm:text-base md:text-lg">The information we collect is used for:</p>
        <ul className="list-disc list-inside mb-4 text-gray-700 text-sm sm:text-base md:text-lg">
